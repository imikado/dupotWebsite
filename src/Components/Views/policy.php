    ...
    <p>
        Michael Bertocchi built the <?php echo $this->paramList['label'] ?> app as
        an Open Source app. This SERVICE is provided by
        Michael Bertocchi at no cost and is intended for use as
        is.
    </p>
    <p>
    ...
    <p>
        ...
        <?php echo $this->paramList['label'] ?> unless otherwise defined in this Privacy Policy.
    </p>
    ...
    <p>This policy is effective as of 2021-05-25</p>
    <p><strong>Contact Us</strong></p>
    <p>
        If you have any questions or suggestions about my
        Privacy Policy, do not hesitate to contact me at imikado@gmail.com.
    </p>
